...
public class DAOUtils {
	...
	public static String addPorcentaje(String clause) {
		StringBuilder clausePorcentaje = new StringBuilder("%");
		clausePorcentaje.append(clause);
		clausePorcentaje.append("%");
		
		return clausePorcentaje.toString();
	}
